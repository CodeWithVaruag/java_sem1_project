...
public class restaurantdashboard implements ActionListener,MouseListener{
...
public restaurantdashboard() {
	...
	confirm.setBounds(680,350,150,50);
	...
	logout.setBounds(850,350,150,50);
	...
	JLabel naya=new JLabel(new ImageIcon("C:/Users/ACER/eclipse-workspace/app/src/ui/fd.jpg"));
...
public void updateTable() {
	a1= new JDBC_food().foodselect();
	model.setRowCount(0);
	for (food2_library b : a1) {
		Object tmpRow[] = {

				b.getUsername(),b.getOrderid(),b.getBookingid(),b.getFood(),b.getFoodquantity(),b.getFoodrate(),b.getFoodstatus()
		};
...
public void actionPerformed(ActionEvent e) {
	...
	{
		food_library o=new food_library();
		o.setOrderid(Integer.parseInt(txtorderid.getText()));
		o.setFoodstatus("booked");
		
		JDBC_food q=new JDBC_food();
	    boolean result=q.confirmfood(o);
	    updateTable();
	
	    
	    if (result=true) {
	    	
	    	JOptionPane.showMessageDialog(null, " food is ready to be served ");
	    }
	}
